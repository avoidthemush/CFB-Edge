"""
One-time baseline snapshot of every table's row count, taken at the end
of the V1 data-gathering phase. Useful as a reference point if something
looks off later - compare a future count against this to spot unexpected
growth, shrinkage, or a sync that silently stopped working.
"""
...
from app.models import (
    ...
    TeamSourceAlias, Player, PlayerSeasonStat,
)
