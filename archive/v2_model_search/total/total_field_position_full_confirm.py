"""
Phase 2 confirmation for field_position - dominant recurrence in the
massive search (12/40), confirmed on an independent split (2023, 2024
both cleared comfortably), and confirmed structurally distinct from
team quality/pace (correlation checks passed). Full test including
2025 - a real, earned spend.
"""
import numpy as np
import pandas as pd
