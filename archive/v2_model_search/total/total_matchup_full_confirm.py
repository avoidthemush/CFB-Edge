"""
Phase 2 confirmation for the matchup-based Total approach - full 4-fold
walk-forward (spends a real look at 2025) + bootstrap. Same standard as
every approved Spread system and the earlier (failed) additive Total
attempt.
"""
import numpy as np
import pandas as pd
...
def run():
    ...
    for train_start, train_end, test_year in FOLDS:
        ...
        df_test["predicted_total"] = preds
        df_test["gap"] = df_test["predicted_total"] - df_test["market_total_open"]
