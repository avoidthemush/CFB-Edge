"""
Phase 2 confirmation for the Total regression approach - full 4-fold
walk-forward (spends a real look at 2025) + bootstrap resampling, same
standard applied to every approved Spread system.
"""
import numpy as np
import pandas as pd
