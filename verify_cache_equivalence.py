...
generation. Run this after any change to the caching logic - including
the Aug 2026 matchup/coach-quality/h2h additions.
"""
...
test_games = db.query(Game).filter(
    Game.season == 2023, Game.completed == True
).limit(100).all()

cache = FeatureCache(2023, 2023)
